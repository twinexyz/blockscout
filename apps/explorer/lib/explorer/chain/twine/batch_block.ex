defmodule Explorer.Chain.Twine.BatchBlock do
  @moduledoc "Models a list of blocks related to a batch for Twine."
  ...
  @required_attrs ~w(batch_number )a
  ...
  @primary_key false
  schema "twine_batch_l2_blocks" do
