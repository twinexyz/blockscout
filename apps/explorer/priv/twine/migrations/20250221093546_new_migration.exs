defmodule Explorer.Repo.Twine.Migrations.CreateTwineTables do
  ...
  def change do
    ...
    create table(:twine_transaction_batches, primary_key: false) do
      ...
      add(
        :commit_id,
        references(:twine_lifecycle_l1_transactions, on_delete: :restrict, on_update: :update_all, type: :integer),
        null: true
      )
    ...
    create table(:twine_batch_l2_transactions, primary_key: false) do
      add(
        :batch_number,
        references(:twine_transaction_batches,
          column: :number,
